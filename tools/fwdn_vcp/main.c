...
static void AutoParking_StartTask(void *pArg)
{
    ...
    double distRear = 0, distFront = 0;
    // double distanceLeft = 0; 
    double distSideFront = 0.0;  // 옆면-앞쪽 센서
    double distSideRear  = 0.0;  // 옆면-뒤쪽 센서

    unsigned long startPosTime = 0, endPosTime = 0; 
    double spaceLength = 0;
    const double carLength = 60.0;  // 단위: cm
    ...
    for (;;)
    {
        mcu_printf("[AutoParking_StartTask] Task start!!\n");
